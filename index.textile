...
<div class='contentblock leftshift reference' id='projects'>
h2. Projects
...
<div class='contentblock leftshift reference' id='resources'>
h2. Other resources
...
div(post). "{{ post.title }}":{{ post.url }} %(date){{ post.date | date_to_string }}%
{% endfor %}
