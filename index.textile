...
<div id='employment' class='section medium'>
h2. Employment
...
<div id='projects' class='section medium'>
h2. Projects
...
p. Some of the tools I use:
* Linux: Ubuntu, Debian, Gentoo
* Google Apps (they host my network mail, it's nice.)
* Google AppEngine (_much_ easier than setting up my own massive hosting/storage/monitoring network)

</div></div>

<div id='postsdiv' class='section small'>
h2. Posts via GitHub
...
<div id='ideas' class='section big'>
h2. Ideas
