...
* In some cases, it simply injects extra @<br>@. 

You can imagine how problematic that becomes. I've included an example... 
...
h3. Table Example
	...
	This table will have extra @<br>@ injected

<table>{% for i in page.entries %}
